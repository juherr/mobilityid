...
- Security gates: dependency review on pull requests (`dependency-review.yml`, fails on high+), Dependabot alerts on `main`, and a weekly/on-demand OWASP Dependency-Check full scan (`security.yml`, not a PR gate).
