...
- Fork and Dependabot pull requests get their Java graph submitted and reviewed by `.github/workflows/fork-dependency-graph.yml` after provenance validation (see `CONTRIBUTING.md`).
