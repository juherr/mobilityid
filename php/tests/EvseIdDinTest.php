...
final class EvseIdDinTest extends TestCase
{
    ...
    public function testOfDinEvseIdStringWithAndWithoutPlusSign(): void
    {
        ...
        self::assertEquals($evseIdWithPlus, $evseIdWithoutPlus);
    }
    ...
    public function testOfDinEvseIdStringWith6CharOperator(): void
    {
        ...
        $evseId = EvseIdDin::of($evseIdString);
        self::assertSame('+49', (string) $evseId->countryCode);
        self::assertSame('810548', (string) $evseId->operatorId);
        self::assertSame('1234567890', $evseId->powerOutletId);
    }
